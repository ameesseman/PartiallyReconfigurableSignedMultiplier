...
END tb_mycordicAXI4Full;
 
ARCHITECTURE behavior OF tb_mycordicAXI4Full IS 
 
    -- Component Declaration for the Unit Under Test (UUT)
 
component mycordicfull_v1_0
        port (
...
BEGIN
   ...
   uut: mycordicfull_v1_0 PORT MAP ( s00_axi_aclk, s00_axi_aresetn, s00_axi_awid, s00_axi_awaddr, s00_axi_awlen, s00_axi_awsize, s00_axi_awburst, s00_axi_awlock, s00_axi_awcache,
   ...
   begin		
      -- hold reset state for 100 ns.
        ...
        -- *************        
        AXI_WDATA_IN(0) <= x"000026DC";
	    AXI_WDATA_IN(1) <= x"21820000";
        ...
        WRITE_DATA ("101000", "00000001", "00", AXI_WDATA_IN,
        ...
        READ_DATA ("101000", "00000001", "01", -- Expected Results: 
        ...
        -- 2 32-bit words: Transmission and reception
        -- *************        
        AXI_WDATA_IN(0) <= x"33333333";
	    AXI_WDATA_IN(1) <= x"00008000";
        --   axi_awlen <= "00000001"; -- 2 transfers
        --   axi_awburst <= "00"; -- "FIXED" (address remains constant during transmission        
        -- We write on Address 10, but in this FIFO configuration, the address does not matter.
        WRITE_DATA ("101000", "00000001", "00", AXI_WDATA_IN,
